...
public class SedanVehicleService implements VehicleService {
	...
	@Autowired
	public SedanVehicleService(VehicleDao vehicleDao, VehicleCheckService vehicleCheckService,
	...
	public Result add(VehicleDto vehicleDto) {
		...
		vehicleDto.setFeeFactor(1.0);
		vehicleDto.setType(VehicleType.SEDAN);
		Vehicle vehicle = modelMapper.map(vehicleDto, Vehicle.class);
		this.vehicleDao.save(vehicle);
		return new SuccessResult("Sedan vehicle added.");
	}
