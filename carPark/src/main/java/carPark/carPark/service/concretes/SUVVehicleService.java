...
public class SUVVehicleService implements VehicleService{
	...
	@Autowired
	public SUVVehicleService(VehicleDao vehicleDao, VehicleCheckService vehicleCheckService,
